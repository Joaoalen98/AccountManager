...
namespace AccountManager.Repository.Migrations
{
    ...
    [Migration("20250319002330_Fix_User_Account_RelationShip")]
    partial class Fix_User_Account_RelationShip
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccountManager.Domain.Entities.Account", b =>
                {
                    b.HasOne("AccountManager.Domain.Entities.User", "User")
                        .WithOne("Account")
                        .HasForeignKey("AccountManager.Domain.Entities.Account", "UserId")
